...
**2. Activity Strategy Cards (26 cards)**
Color-coded by engagement level:
- **Receiving (Blue)** - 3 cards
- **Responding (Green)** - 14 cards  
- **Creating (Orange)** - 9 cards

Each card includes hybrid implementation guidance, time estimates, and technology requirements. Cards are placed directly on the canvas for visual planning.

**3. Assessment Method Cards (14 cards)**
...
**4. Hybrid Adaptation Planning Worksheet**
...
**5. Modality Planning Reference Guide**
...
- **Activity Sequence Canvas Generator**: Create customized planning templates with dynamic segments (3-8), multiple scaling options (session/module/course), and high-resolution export (PNG/PDF)
- **Activity Strategy Cards Generator**: Digital display and navigation of all 26 cards by engagement level or purpose, with batch export functionality
- **Assessment Method Cards Generator**: Browse and export assessment cards with filtering by purpose and engagement alignment
...
1. Use the Canvas to map one learning session with basic progression
2. Select 3-5 Activity Cards focusing on Receiving and Responding levels
3. Choose formative Assessment Cards for equity checking
